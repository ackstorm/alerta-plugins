...
TAGS_TO_ATTRIBUTES = ['timeperiod', 'cluster']


class PrometheusParser(PluginBase):
    def __init__(self, name=None):
        super(PrometheusAdapter, self).__init__(name)
    ...
    def _parse_prometheus(alert):
        ...
        alert.environment = 'prod' if alert.attributes.get('env') in ['pro', 'prd'] else alert.environment
